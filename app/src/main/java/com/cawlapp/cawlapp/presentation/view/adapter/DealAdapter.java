...
import com.cawlapp.cawlapp.databinding.ItemDealsBinding;
...
//        picasso = Picasso.with(context);
    ...
    public DealsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ItemDealsBinding binding = ItemDealsBinding.inflate(inflater, parent, false);
        return new DealsViewHolder(binding.getRoot());
...
//        return new DealsViewHolder(view);
    ...
    public void onBindViewHolder(DealsViewHolder holder, final int position) {
        ...
        holder.binding.setDeal(dealModel);
