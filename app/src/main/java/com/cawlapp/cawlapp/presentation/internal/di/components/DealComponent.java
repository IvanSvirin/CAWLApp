 ...
 */
@PerActivity
@Component(dependencies = ApplicationComponent.class, modules = {ActivityModule.class, DealModule.class})
public interface DealComponent extends ActivityComponent {
  void inject(HotDealsTabFragment hotDealsTabFragment);
}
