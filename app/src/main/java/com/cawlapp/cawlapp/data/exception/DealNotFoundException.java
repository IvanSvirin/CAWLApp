 ...
 */
package com.cawlapp.cawlapp.data.exception;
...
public class DealNotFoundException extends Exception {
  ...
  public DealNotFoundException(final String message, final Throwable cause) {
    super(message, cause);
  }

  public DealNotFoundException(final Throwable cause) {
    super(cause);
  }
}
